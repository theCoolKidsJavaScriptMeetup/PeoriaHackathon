    ...
    return (
      <div className="Footer">
        ...
        <div className="createdBy">
          <a target="_blank" rel="noopener noreferrer" href="https://github.com/theCoolKidsJavaScriptMeetup">Made with <i className="fa fa-heart"></i> by The Cool Kids Javascript Meetup</a>
        </div>
      </div>
    );
  }
