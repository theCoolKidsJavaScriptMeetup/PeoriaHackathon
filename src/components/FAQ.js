        ...
        return (
            <div className="Content">
                ...
                <div className="faq-group">
                    <FAQCard title="What project will I be working on at the Hackathon?" answer={<div> At 8:30AM on August 12, the day of the Civic Hackathon, organizers will announce a Challenge Statement that participants will be asked to solve for during the day. <p>Along with the Challenge Statement, organizers will also release data set(s) that may be relevant for the challenge. Other publicly available data sets may also be used by participants for their projects, at their discretion.</p></div>}/>
