        ...
        return (
            <div className="Content">
                ...
                <div className="faq-group">
                    ...
                    <FAQCard title="How much does it cost?" answer={<div>Due to our generous <Link className="faq_link" to="/sponsors">sponsors</Link>, the Peoria Civic Hackathon is free to attend!</div>}/>
                    ...
                    <FAQCard title="How do I register a team?" answer={<div>Please head over to the <Link className="faq_link" to="/registration">team registration page!</Link></div>}/>
