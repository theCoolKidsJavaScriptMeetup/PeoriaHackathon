        ...
        return (
            <div className="Content">
                ...
                <div className="faq-group">
                    ...
                    <FAQCard title="When should I arrive?" answer={<div><div>Friday 8/11: <i>(Optional)</i> Join us between 6:00PM-8:00PM for a social event. This is a good opportunity to create or join a team and socialize with fellow participants.<br/><br/>Saturday 8/12: Check-in and registration will take place between 8AM-8:30AM on Saturday morning.</div></div>}/>
