...
const RegistrationSuccess = (props) => {
    return (<div className="Content center-text">
        ...
        <h3>You're officially registered {(props.match.params.id !== null && props.match.params.id !== "undefined") ? "with Team " + props.match.params.id : null } for the 2017 Peoria Civic Hackathon!</h3>
